...
const CoFounderMessage = () => {
  ...
  return (
    <section className="mt-30 w-full flex flex-col lg:flex-row items-stretch bg-[#000D2D]">
      ...
      <div className="flex-1 flex flex-col justify-center lg:-ml-12 px-8 lg:px-0 lg:pr-24 mt-8 lg:mt-32 mb-8">
        <h2 className="text-3xl md:text-4xl text-white font-[500] mb-6 leading-tight px-6 lg:px-0">
          {t('coFounderTitle')}
        </h2>
        <Quote className="w-10 h-10 text-white/20 mb-2" />
        <p className="text-[16px] md:text-[16px] font-[400] text-white/70 mb-10 max-w-2xl px-6 lg:px-0">
          {t('coFounderBody')}
        </p>
